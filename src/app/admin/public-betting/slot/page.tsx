...
const stores = [
  { bonsa: "test1", storeId: "cvv7969", nickname: "홀덤매1", betting: 2278554, winning: 1642565, rolling: 93421, loss: 30 },
  { bonsa: "test1", storeId: "popo11", nickname: "홀덤매2", betting: 0, winning: 0, rolling: 0, loss: 30 },
  { bonsa: "오카다본사", storeId: "ass00", nickname: "남지매장", betting: 0, winning: 0, rolling: 0, loss: 0 },
  { bonsa: "test1", storeId: "as5903", nickname: "as5903", betting: 0, winning: 0, rolling: 0, loss: 30 },
  ...
  { bonsa: "test1", storeId: "test4", nickname: "test4", betting: 21437642, winning: 20232726, rolling: 515148, loss: 0 },
  { bonsa: "오카다본사", storeId: "pss691501", nickname: "대천매장", betting: 0, winning: 0, rolling: 0, loss: 0 },
];

export default function SlotPublicBettingPage() {
  return (
        ...
        <Table>
          <TableHeader>
            <TableRow className="border-green-900/15 hover:bg-transparent">
              {["소속본사", "매장 ID", "매장 닉네임", "전일 슬롯베팅", "전일 슬롯당첨", "전일 슬롯롤링", "빼기", "LOSS", "더하기"].map((h) => (
              ...
              <TableRow key={i} className="border-green-900/10 hover:bg-white/[0.02]">
                ...
                <TableCell className="text-center">
                  <div className="flex items-center justify-center gap-1">
                    <button className="px-2 py-1 bg-red-600 text-white text-[10px] font-bold rounded hover:bg-red-500">-10</button>
                    <button className="px-2 py-1 bg-red-600 text-white text-[10px] font-bold rounded hover:bg-red-500">-</button>
                  </div>
                </TableCell>
                <TableCell className="text-center text-sm text-white font-bold">{store.loss}</TableCell>
                <TableCell className="text-center">
                  <div className="flex items-center justify-center gap-1">
                    <button className="px-2 py-1 bg-blue-700 text-white text-[10px] font-bold rounded hover:bg-blue-600">+</button>
                    <button className="px-2 py-1 bg-blue-700 text-white text-[10px] font-bold rounded hover:bg-blue-600">+10</button>
                  </div>
                </TableCell>
              </TableRow>
            ))}
